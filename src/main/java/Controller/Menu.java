...
public class Menu {
    ...
    public static String escolherMoeda() throws Exception {
        ...
        System.out.println("4 - Libra Esterlina/Real Brasileiro");

        int conversao = new Scanner(System.in).nextInt();
        String escolhaMoeda = "";
        Moeda moeda;
        String code;
        String codein;
        switch (conversao){
            case 1:
                ...
                code = "USD";
                codein = "BRL";
                moeda = MoedaService.buscaMoeda(code, codein);
